...
export const metadata = withPageCanonical(pageMetadata, "/home-valuation");
        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">Home Valuation</span>
            </nav>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto mb-16">
            {/* Calendly Widget */}
            <div className="bg-white border border-lmhy-sand/60 rounded-lg overflow-hidden">
              <div className="bg-lmhy-coral text-white p-4 text-center">
              ...
              <p className="text-xs text-lmhy-charcoal/60 text-center p-4 border-t border-lmhy-sand/60">
            ...
            <div className="space-y-8">
              <div className="bg-lmhy-charcoal text-white rounded-lg p-8">
              ...
              {/* Market Stats */}
              <div className="bg-lmhy-coral/5 rounded-lg p-8">
                <h3 className="font-bold text-lmhy-charcoal mb-4">Las Vegas Market | January 2026</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-lmhy-coral">$450K</div>
                    <div className="text-sm text-lmhy-charcoal/70">Median Home Price</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">+4.2%</div>
                    <div className="text-sm text-lmhy-charcoal/70">YoY Appreciation</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-lmhy-coral">28 Days</div>
                    <div className="text-sm text-lmhy-charcoal/70">Avg. Days on Market</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-lmhy-coral">2.1 Mo</div>
                    <div className="text-sm text-lmhy-charcoal/70">Inventory</div>
                  </div>
                </div>
              </div>

              {/* Expert Quote */}
              <div className="bg-lmhy-sand/20 rounded-lg p-6">
                <blockquote className="text-lmhy-charcoal/80 italic mb-3">
                ...
                <cite className="text-lmhy-charcoal font-semibold text-sm">
              ...
              {/* Call Option */}
              <div className="text-center">
                <p className="text-lmhy-charcoal/70 mb-4">Prefer to talk? Call Dr. Jan directly:</p>
                <a
                  href="tel:+17025001942"
                  className="inline-flex items-center bg-lmhy-coral hover:bg-lmhy-coral-dark text-white px-6 py-3 rounded-md font-bold transition-colors"
                >
          ...
          <section className="max-w-5xl mx-auto mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12">
            <h2 className="text-3xl font-bold text-lmhy-charcoal mb-8 text-center">
              Key Factors That Affect Your Las Vegas Home's Value
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <MapPin className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Location & Neighborhood</h3>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <Home className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Size & Layout</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <TrendingUp className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Upgrades & Condition</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <DollarSign className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Market Conditions</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <Calculator className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Lot Characteristics</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <Clock className="h-8 w-8 text-lmhy-coral mb-4" />
                <h3 className="font-bold text-lmhy-charcoal mb-2">Age & Systems</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
            ...
            <div className="overflow-x-auto">
              <table className="w-full bg-white border border-lmhy-sand/60 rounded-lg">
                <thead className="bg-lmhy-sand/20">
                  <tr>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Neighborhood</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Median Price</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-lmhy-charcoal">YoY Change</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Avg $/SqFt</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={row.area} className={index % 2 === 0 ? "bg-white" : "bg-lmhy-sand/20"}>
                      <td className="px-6 py-4 font-medium text-lmhy-charcoal">{row.area}</td>
                      <td className="px-6 py-4 text-lmhy-charcoal/80">{row.price}</td>
                      <td className="px-6 py-4 text-green-600 font-medium">{row.change}</td>
                      <td className="px-6 py-4 text-lmhy-charcoal/80">{row.sqft}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            </div>
            <p className="text-center text-lmhy-charcoal/60 text-sm mt-4">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Share Your Property Details</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Comprehensive Market Analysis</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Feature Adjustments</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Pricing Strategy Consultation</h3>
                  <p className="text-lmhy-charcoal/70">
