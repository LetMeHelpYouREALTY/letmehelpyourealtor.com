        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">North Las Vegas</span>
            </nav>
          </div>
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-lmhy-gold mb-1">$385,000</div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="prose prose-lg max-w-none text-lmhy-charcoal/80">
              ...
              <div className="grid md:grid-cols-2 gap-8 not-prose">
                <div className="bg-lmhy-sand/20 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    <DollarSign className="h-8 w-8 text-lmhy-coral mr-3" />
                    <h4 className="font-bold text-lmhy-charcoal text-lg">Most Affordable in the Valley</h4>
                  </div>
                ...
                <div className="bg-lmhy-sand/20 p-6 rounded-xl">
                  <div className="flex items-center mb-4">
                    <TrendingUp className="h-8 w-8 text-lmhy-coral mr-3" />
                    <h4 className="font-bold text-lmhy-charcoal text-lg">Rapid Growth & Development</h4>
                  </div>
                  <p className="text-lmhy-charcoal/70">
              ...
              {/* Major Employers */}
              <h3 className="text-2xl font-bold text-lmhy-charcoal mt-12 mb-6">Major North Las Vegas Employers</h3>
              ...
              {/* School Districts */}
              <h3 className="text-2xl font-bold text-lmhy-charcoal mt-12 mb-6">North Las Vegas Schools</h3>
              <div className="not-prose bg-white border border-lmhy-sand/60 rounded-xl p-6">
                <p className="text-lmhy-charcoal/80 mb-4">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <h5 className="font-bold text-lmhy-charcoal mb-2">Top Elementary</h5>
                  ...
                  <div>
                    <h5 className="font-bold text-lmhy-charcoal mb-2">Charter Options</h5>
                    <ul className="text-lmhy-charcoal/70 text-sm space-y-1">
              ...
              {/* Commute Times */}
              <h3 className="text-2xl font-bold text-lmhy-charcoal mt-12 mb-6">Commute Times from North Las Vegas</h3>
              <div className="not-prose overflow-x-auto">
                <table className="w-full bg-white border border-lmhy-sand/60 rounded-lg">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    ...
                    <tr className="bg-lmhy-sand/20"><td className="px-4 py-3">Las Vegas Strip</td><td className="px-4 py-3">10 miles</td><td className="px-4 py-3">18 min</td><td className="px-4 py-3">25-40 min</td></tr>
                    ...
                    <tr className="bg-lmhy-sand/20"><td className="px-4 py-3">Summerlin</td><td className="px-4 py-3">18 miles</td><td className="px-4 py-3">25 min</td><td className="px-4 py-3">35-50 min</td></tr>
              ...
              <h3 className="text-2xl font-bold text-lmhy-charcoal mt-12 mb-6">New Construction Communities</h3>
              <div className="not-prose grid md:grid-cols-2 gap-6">
                <div className="bg-lmhy-sand/20 rounded-xl p-6">
                  <h5 className="font-bold text-lmhy-charcoal mb-3">Active Builder Communities</h5>
                ...
                <div className="bg-lmhy-sand/20 rounded-xl p-6">
                  <h5 className="font-bold text-lmhy-charcoal mb-3">Healthcare & Services</h5>
                  <ul className="text-lmhy-charcoal/70 text-sm space-y-2">
