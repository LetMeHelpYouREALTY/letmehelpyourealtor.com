...
export const metadata = withPageCanonical(pageMetadata, "/listings");
        ...
        <div className="lmhy-container">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {popularSearches.map((search) => (
                <Link
                  key={search.name}
                  href={search.href}
                  className="bg-white border border-lmhy-sand/60 rounded-lg p-4 hover:shadow-lg hover:border-lmhy-coral/30 transition-all group flex justify-between items-center"
                >
                  <div>
                    <h3 className="font-bold text-lmhy-charcoal group-hover:text-lmhy-coral">
                      {search.name}
                    </h3>
                    <span className="text-sm text-lmhy-charcoal/60">{search.count} listings</span>
                  </div>
                  <ArrowRight className="h-5 w-5 text-lmhy-charcoal/50 group-hover:text-lmhy-coral" />
                </Link>
              ))}
            </div>
          </section>
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-4">
              {priceRanges.map((price, index) => (
                <div
                  key={price.range}
                  className="bg-white rounded-lg p-4 border border-lmhy-sand/60 flex flex-col md:flex-row md:items-center justify-between"
                >
                  <div className="flex items-center mb-2 md:mb-0">
                    <DollarSign className="h-5 w-5 text-green-600 mr-3" />
                    <div>
                      <h3 className="font-bold text-lmhy-charcoal">{price.range}</h3>
                      <p className="text-sm text-lmhy-charcoal/70">{price.description}</p>
                    </div>
                  </div>
                  <span className="text-lmhy-coral font-semibold">{price.count} homes</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {neighborhoods.map((neighborhood) => (
                <div
                  ...
                  className="bg-white border border-lmhy-sand/60 rounded-lg p-6 hover:shadow-lg transition-shadow"
                >
                  <h3 className="font-bold text-lg text-lmhy-charcoal mb-2">{neighborhood.name}</h3>
                  <p className="text-lmhy-charcoal/70 text-sm mb-4">{neighborhood.description}</p>
                  <div className="flex justify-between text-sm">
                    <span className="text-lmhy-charcoal/60">Median: <strong className="text-lmhy-charcoal">{neighborhood.medianPrice}</strong></span>
                    <span className="text-lmhy-charcoal/60">DOM: <strong className="text-lmhy-charcoal">{neighborhood.daysOnMarket} days</strong></span>
                  </div>
                </div>
              ))}
            </div>
            <div className="text-center mt-8">
              <Link
                href="/neighborhoods"
                className="inline-flex items-center text-lmhy-coral hover:text-lmhy-coral-dark font-semibold"
              >
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="bg-lmhy-coral w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-lmhy-coral mb-1">$450K</div>
                <div className="text-sm text-lmhy-charcoal/70">Median Home Price</div>
              </div>
              <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-lmhy-coral mb-1">28</div>
                <div className="text-sm text-lmhy-charcoal/70">Avg Days on Market</div>
              </div>
              <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-lmhy-coral mb-1">4,850</div>
                <div className="text-sm text-lmhy-charcoal/70">Active Listings</div>
              </div>
              <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-lmhy-coral mb-1">+4.2%</div>
                <div className="text-sm text-lmhy-charcoal/70">Year-Over-Year</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-lmhy-coral text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0">
                  1
                </div>
                <div>
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Get Pre-Approved for Financing</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Define Your Priorities & Search</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Tour Properties & Make an Offer</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Due Diligence & Inspections</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Close & Get Your Keys</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
