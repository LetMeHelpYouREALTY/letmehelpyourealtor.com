...
export const metadata = withPageCanonical(pageMetadata, "/buyers/first-time-buyers");
        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">First-Time Buyers</span>
            </nav>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-lmhy-charcoal mb-6">
              ...
              <span className="text-lmhy-coral">Starts Here</span>
            </h1>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 text-center">
                <div className="bg-lmhy-coral/10 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-lmhy-coral">3.5%</span>
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">FHA Loans</h3>
                <p className="text-sm text-lmhy-charcoal/70 mb-3">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-lmhy-charcoal mb-2">VA Loans</h3>
                <p className="text-sm text-lmhy-charcoal/70 mb-3">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-lmhy-charcoal mb-2">Conventional</h3>
                <p className="text-sm text-lmhy-charcoal/70 mb-3">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 text-center">
                ...
                <h3 className="font-bold text-lmhy-charcoal mb-2">Down Payment Help</h3>
                <p className="text-sm text-lmhy-charcoal/70 mb-3">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lg text-lmhy-charcoal">North Las Vegas</h3>
                  <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-semibold">Best Value</span>
                </div>
                <div className="text-2xl font-bold text-lmhy-coral mb-2">$350K - $450K</div>
                ...
                <Link
                  ...
                  className="block mt-4 text-lmhy-coral font-semibold hover:text-lmhy-coral-dark text-sm"
                >
              ...
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lg text-lmhy-charcoal">Mountains Edge</h3>
                  <span className="bg-lmhy-coral/10 text-lmhy-coral-dark px-2 py-1 rounded text-xs font-semibold">Great Parks</span>
                </div>
                <div className="text-2xl font-bold text-lmhy-coral mb-2">$380K - $480K</div>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
              ...
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lg text-lmhy-charcoal">Centennial Hills</h3>
                  <span className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-semibold">Top Schools</span>
                </div>
                <div className="text-2xl font-bold text-lmhy-coral mb-2">$398K Median</div>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Get Pre-Approved (1-3 days)</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Find Your Home (2-8 weeks)</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Make an Offer & Negotiate (1-5 days)</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Inspections & Due Diligence (10-14 days)</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Close & Get Your Keys (30-45 days total)</h3>
                  <p className="text-lmhy-charcoal/70">
