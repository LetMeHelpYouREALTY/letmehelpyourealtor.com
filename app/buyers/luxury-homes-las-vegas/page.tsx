...
export const metadata = withPageCanonical(pageMetadata, "/buyers/luxury-homes-las-vegas");
        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">Luxury Homes</span>
            </nav>
          </div>

          {/* Hero */}
          <div className="max-w-4xl mx-auto text-center mb-16">
            <div className="inline-flex items-center bg-lmhy-charcoal text-white px-4 py-2 rounded-full text-sm font-semibold mb-6">
            ...
            <a
              ...
              className="inline-flex items-center bg-lmhy-charcoal text-white px-8 py-4 rounded-md font-bold text-lg hover:bg-lmhy-charcoal-light transition-colors"
            >
          ...
          <section className="mb-16 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">Appreciation Since 2015</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400 mb-2">#4</div>
                <div className="text-white/70 text-sm">National Luxury Growth</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400 mb-2">$1.45M</div>
                <div className="text-white/70 text-sm">Luxury Median (Dec 2025)</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400 mb-2">60%</div>
                <div className="text-white/70 text-sm">Cash Transactions</div>
              </div>
            </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* The Ridges */}
              <div className="bg-white border border-lmhy-sand/60 rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-2xl font-bold text-lmhy-charcoal">$1.5M - $10M+</span>
                  ...
                  <ul className="space-y-2 mb-4">
                    <li className="flex items-center text-sm text-lmhy-charcoal/80">
                  ...
                  <Link
                    ...
                    className="text-lmhy-coral font-semibold hover:text-lmhy-coral-dark"
                  >
                    Explore The Ridges →
                  </Link>
                </div>
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-2xl font-bold text-lmhy-charcoal">$2M - $15M+</span>
              ...
              {/* Strip High-Rises */}
              <div className="bg-white border border-lmhy-sand/60 rounded-xl overflow-hidden shadow-lg">
                <div className="bg-lmhy-coral text-white p-6">
                  <h3 className="font-bold text-2xl mb-1">Strip High-Rise Residences</h3>
                  <p className="text-white/85">Lock-and-Leave Luxury Living</p>
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-2xl font-bold text-lmhy-charcoal">$1M - $15M+</span>
                    <span className="bg-lmhy-coral/10 text-lmhy-coral-dark px-3 py-1 rounded-full text-xs font-semibold">
                      Full Service
                    </span>
                  </div>
                  <p className="text-lmhy-charcoal/70 mb-4">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-2xl font-bold text-lmhy-charcoal">$750K - $3M+</span>
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              <Lock className="h-8 w-8 text-lmhy-charcoal/80 mr-3" />
              <h2 className="text-3xl font-bold text-lmhy-charcoal">Privacy & Discretion</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <Eye className="h-5 w-5 text-lmhy-charcoal/70 mr-2 mt-1 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <Shield className="h-5 w-5 text-lmhy-charcoal/70 mr-2 mt-1 flex-shrink-0" />
                    <span><strong>Confidential showings:</strong> Private appointments, no sign-in sheets,
                    discrete documentation.</span>
                  </li>
                  <li className="flex items-start">
                    <DollarSign className="h-5 w-5 text-lmhy-charcoal/70 mr-2 mt-1 flex-shrink-0" />
              ...
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <h3 className="font-bold text-lmhy-charcoal mb-4">Wealth Management Coordination</h3>
                <p className="text-lmhy-charcoal/70 mb-4">
                ...
                <ul className="text-sm text-lmhy-charcoal/80 space-y-2">
