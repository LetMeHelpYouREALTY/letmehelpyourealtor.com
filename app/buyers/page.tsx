...
export const metadata = withPageCanonical(pageMetadata, "/buyers");
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-lmhy-charcoal-light rounded-lg p-8 text-center">
                <Shield className="h-16 w-16 text-lmhy-gold mx-auto mb-4" />
                <p className="text-2xl font-bold mb-2">Your Agent, Your Advocate</p>
                <p className="text-lmhy-charcoal/50 mb-4">
            ...
            <div className="space-y-6">
              {buyingSteps.map((step, index) => {
                ...
                return (
                  <div
                    key={step.title}
                    className="flex gap-6 items-start bg-white border border-lmhy-sand/60 rounded-lg p-6"
                  >
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-xl font-bold text-lmhy-charcoal">{step.title}</h3>
                      </div>
                      <p className="text-lmhy-charcoal/70">{step.description}</p>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {neighborhoods.map((neighborhood) => (
                <div
                  ...
                  className="bg-white rounded-lg p-4 border border-lmhy-sand/60"
                >
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="font-bold text-lmhy-charcoal">{neighborhood.name}</h3>
                    <span className="text-lmhy-coral font-semibold">{neighborhood.price}</span>
                  </div>
                  <p className="text-lmhy-charcoal/70 text-sm">{neighborhood.description}</p>
                </div>
              ))}
            </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link
                ...
                className="bg-white border border-lmhy-sand/60 rounded-xl p-6 hover:shadow-lg transition-shadow group"
              >
                <div className="text-3xl mb-4">🌴</div>
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-2 group-hover:text-lmhy-coral">
                ...
                <span className="text-lmhy-coral font-semibold text-sm">Learn More →</span>
              </Link>
              <Link
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="bg-lmhy-coral/10 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Award className="h-7 w-7 text-lmhy-coral" />
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">Trusted Brand</h3>
              ...
              <div className="text-center">
                <div className="bg-lmhy-coral/10 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Users className="h-7 w-7 text-lmhy-coral" />
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">Global Network</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="text-center">
                <div className="bg-lmhy-coral/10 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-3">
                  <MapPin className="h-7 w-7 text-lmhy-coral" />
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">Local Expertise</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="text-center">
                <div className="bg-lmhy-coral/10 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-3">
                  <TrendingUp className="h-7 w-7 text-lmhy-coral" />
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">Expert Negotiation</h3>
                <p className="text-lmhy-charcoal/70 text-sm">
          ...
          <section className="mb-16 bg-lmhy-coral text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">Year-Over-Year</div>
              </div>
            </div>
          </section>
