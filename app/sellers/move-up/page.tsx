...
export const metadata = withPageCanonical(pageMetadata, "/sellers/move-up");
        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">Move-Up Sellers</span>
            </nav>
          </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex items-center">
                <div className="flex-shrink-0 mr-6">
                  <div className="bg-lmhy-coral/10 rounded-full p-3">
                    <HomeIcon className="h-6 w-6 text-lmhy-coral" />
                  </div>
                </div>
                <div className="flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Centennial Hills → Summerlin</h3>
                ...
                <ArrowRight className="h-6 w-6 text-lmhy-coral flex-shrink-0 ml-4" />
              </div>
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex items-center">
                ...
                <div className="flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Green Valley → MacDonald Ranch</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex items-center">
                ...
                <div className="flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-1">Inspirada → Southern Highlands</h3>
                  <p className="text-lmhy-charcoal/70 text-sm">
              ...
              <div>
                ...
                <ul className="space-y-3 text-lmhy-charcoal/80">
                  <li className="flex items-start">
                    <span className="text-lmhy-coral mr-2">•</span>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                <div className="bg-lmhy-coral/10 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                  <span className="text-lmhy-coral font-bold text-xl">1</span>
                </div>
                <h3 className="font-bold text-lmhy-charcoal mb-2">Sell First, Then Buy</h3>
                ...
                <div className="text-sm">
                  ...
                  <p className="text-lmhy-charcoal/60">Risk-averse buyers; competitive purchase markets</p>
                  <p className="text-amber-600 font-medium mt-2">Consider:</p>
                  <p className="text-lmhy-charcoal/60">May need temporary housing; rent-back negotiation possible</p>
                </div>
              </div>
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                ...
                <h3 className="font-bold text-lmhy-charcoal mb-2">Buy First, Then Sell</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
                ...
                <div className="text-sm">
                  <p className="text-green-600 font-medium">Best for:</p>
                  <p className="text-lmhy-charcoal/60">Buyers with strong equity or savings; hot seller's markets</p>
                  <p className="text-amber-600 font-medium mt-2">Consider:</p>
                  <p className="text-lmhy-charcoal/60">Bridge loan costs; carrying costs if sale delays</p>
                </div>
              </div>
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                ...
                <h3 className="font-bold text-lmhy-charcoal mb-2">Simultaneous Close</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
                ...
                <div className="text-sm">
                  <p className="text-green-600 font-medium">Best for:</p>
                  <p className="text-lmhy-charcoal/60">Experienced buyers; balanced markets; strong coordination</p>
                  <p className="text-amber-600 font-medium mt-2">Consider:</p>
                  <p className="text-lmhy-charcoal/60">Higher stress; requires flexible closing dates</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/10 rounded-xl p-6">
                <DollarSign className="h-8 w-8 text-lmhy-gold mb-4" />
