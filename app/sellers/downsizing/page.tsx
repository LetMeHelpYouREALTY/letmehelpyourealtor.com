...
export const metadata = withPageCanonical(pageMetadata, "/sellers/downsizing");
        ...
        <div className="lmhy-container">
          ...
          <div className="max-w-6xl mx-auto mb-6">
            <nav className="text-sm text-lmhy-charcoal/60">
              ...
              {" / "}
              <span className="text-lmhy-charcoal">Downsizing</span>
            </nav>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white/10 rounded-xl p-6">
                <h3 className="font-bold text-xl mb-4 flex items-center">
                  <HomeIcon className="h-6 w-6 mr-2 text-lmhy-gold" />
                  Your Current Home
                </h3>
                ...
                <div className="text-2xl font-bold text-lmhy-gold">Value: $650K-$900K</div>
              </div>
              <div className="bg-white/10 rounded-xl p-6">
                <h3 className="font-bold text-xl mb-4 flex items-center">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                ...
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-2">55+ Communities</h3>
                ...
                <div className="text-lmhy-coral font-semibold">$375K - $650K</div>
                <Link
                  href="/55-plus-communities"
                  className="block mt-3 text-sm text-lmhy-coral hover:text-lmhy-coral-dark"
                >
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                ...
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-2">Single-Story Homes</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
                ...
                <div className="text-lmhy-coral font-semibold">$400K - $600K</div>
                <Link
                  href="/contact"
                  className="block mt-3 text-sm text-lmhy-coral hover:text-lmhy-coral-dark"
                >
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                ...
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-2">Lock-and-Leave Condos</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-4">
                  Secure, zero-maintenance living. Travel for months without worry.
                  Guard-gated options available in Summerlin and Henderson.
                </p>
                <div className="text-lmhy-coral font-semibold">$275K - $500K</div>
                <Link
                  href="/contact"
                  className="block mt-3 text-sm text-lmhy-coral hover:text-lmhy-coral-dark"
                >
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-4">Selling Your Large Home</h3>
              ...
              <div>
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-4">Finding Your Right-Sized Home</h3>
                <ul className="space-y-3 text-lmhy-charcoal/80">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
          ...
          <section className="mb-16 max-w-4xl mx-auto">
            <div className="bg-lmhy-coral/5 border-l-4 border-lmhy-coral rounded-r-xl p-8">
              <div className="flex items-center mb-4">
                <Heart className="h-6 w-6 text-lmhy-coral mr-2" />
                <h3 className="font-bold text-lg text-lmhy-charcoal">
              ...
              <p className="text-lmhy-charcoal/80">
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="overflow-x-auto">
              <table className="w-full bg-white border border-lmhy-sand/60 rounded-lg">
                <thead className="bg-lmhy-sand/20">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Community</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Price Range</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-lmhy-charcoal">HOA/Mo</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-lmhy-charcoal">Top Amenity</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={community.name} className={index % 2 === 0 ? "bg-white" : "bg-lmhy-sand/20"}>
                      <td className="px-4 py-3 font-medium text-lmhy-charcoal">{community.name}</td>
                      <td className="px-4 py-3 text-lmhy-charcoal/80">{community.price}</td>
                      <td className="px-4 py-3 text-lmhy-charcoal/80">{community.hoa}</td>
                      <td className="px-4 py-3 text-lmhy-charcoal/80">{community.amenity}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <p className="text-center mt-4">
              <Link href="/55-plus-communities" className="text-lmhy-coral hover:text-lmhy-coral-dark font-semibold">
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-4">Financial Factors</h3>
                <ul className="space-y-3 text-lmhy-charcoal/80">
                  <li className="flex items-start">
              ...
              <div>
                <h3 className="font-bold text-lg text-lmhy-charcoal mb-4">Lifestyle Factors</h3>
                <ul className="space-y-3 text-lmhy-charcoal/80">
                  <li className="flex items-start">
                    <Users className="h-5 w-5 text-lmhy-coral mr-2 mt-0.5 flex-shrink-0" />
                    <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Discovery Conversation</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Equity Analysis & Options Review</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Tour & Compare</h3>
                  <p className="text-lmhy-charcoal/70">
              ...
              <div className="flex items-start">
                ...
                <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6 flex-grow">
                  <h3 className="font-bold text-lmhy-charcoal mb-2">Coordinated Transaction</h3>
                  <p className="text-lmhy-charcoal/70">
