...
export const metadata = withPageCanonical(pageMetadata, "/contact");
      ...
      <main className="pt-24 pb-16">
        <div className="lmhy-container">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-lmhy-charcoal/70 max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Contact Info & Map */}
            <div>
              <h2 className="text-2xl font-bold text-lmhy-charcoal mb-6">Get In Touch</h2>
              <p className="text-lmhy-charcoal/80 mb-8">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start bg-lmhy-sand/20 rounded-lg p-4">
                  <Phone className="h-6 w-6 text-lmhy-coral mr-4 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-lmhy-charcoal mb-1">Phone (Call or Text)</h3>
                    <a
                      href="tel:+17025001942"
                      className="text-2xl font-bold text-lmhy-coral hover:text-lmhy-coral-dark"
                    >
                      (702) 500-1942
                    </a>
                    <p className="text-sm text-lmhy-charcoal/60 mt-1">
                ...
                <div className="flex items-start bg-lmhy-sand/20 rounded-lg p-4">
                  <Mail className="h-6 w-6 text-lmhy-coral mr-4 flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start bg-lmhy-sand/20 rounded-lg p-4">
                  <MapPin className="h-6 w-6 text-lmhy-coral mr-4 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-lmhy-charcoal mb-1">Office Address</h3>
                    <address className="not-italic text-lmhy-charcoal/80">
                ...
                <div className="flex items-start bg-lmhy-sand/20 rounded-lg p-4">
                  <Clock className="h-6 w-6 text-lmhy-coral mr-4 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-lmhy-charcoal mb-1">Office Hours</h3>
              ...
              <div className="flex gap-3 mb-8">
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center bg-lmhy-coral hover:bg-lmhy-coral-dark text-white px-4 py-3 rounded-lg font-medium transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 inline-flex items-center justify-center bg-slate-100 hover:bg-slate-200 text-lmhy-charcoal/80 px-4 py-3 rounded-lg font-medium transition-colors"
                >
                  View on Google Maps
                </a>
              </div>
              ...
              {/* Credentials */}
              <div className="p-4 bg-lmhy-coral/5 rounded-lg">
                <p className="text-sm text-lmhy-charcoal/80">
            ...
            <div>
              <div className="bg-white border border-lmhy-sand/60 rounded-xl overflow-hidden shadow-sm">
                <div className="bg-lmhy-coral text-white p-6 text-center">
              ...
              {/* Why Contact BHHS */}
              <div className="mt-6 bg-lmhy-charcoal text-white rounded-xl p-6">
                <h3 className="font-bold text-lg mb-4">Why Contact Berkshire Hathaway HomeServices?</h3>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <Shield className="h-5 w-5 text-lmhy-gold mr-3 mt-0.5 flex-shrink-0" />
                  ...
                  <div className="flex items-start">
                    <Star className="h-5 w-5 text-lmhy-gold mr-3 mt-0.5 flex-shrink-0" />
                    <p className="text-white/70 text-sm">
                      <strong className="text-white">Proven Results:</strong> $127M+ in closed transactions serving Las Vegas since 2008.
                    </p>
                  </div>
                  <div className="flex items-start">
                    <Users className="h-5 w-5 text-lmhy-gold mr-3 mt-0.5 flex-shrink-0" />
                    <p className="text-white/70 text-sm">
          ...
          <section className="max-w-5xl mx-auto mt-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={area} className="bg-lmhy-sand/20 rounded-lg p-3 text-center hover:bg-lmhy-cream transition-colors">
                  <span className="text-lmhy-charcoal/80 font-medium text-sm">{area}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="max-w-4xl mx-auto mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <a
                href="tel:+17025001942"
                className="flex items-center justify-center bg-lmhy-coral hover:bg-lmhy-coral-dark text-white p-6 rounded-xl transition-colors"
              >
                <Phone className="h-8 w-8 mr-4" />
                <div className="text-left">
                  <div className="font-bold text-lg">Call Now</div>
                  <div className="text-white/85">(702) 500-1942</div>
                </div>
              </a>
              <a
                href="mailto:DrDuffy@LetMeHelpYouRealtor.com"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-white/70">Homes@HeyBerkshire.com</div>
                </div>
              </a>
            </div>
          </section>
