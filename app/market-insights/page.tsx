        ...
        <div className="lmhy-container">
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-5 gap-4">
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">California Migration</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-lmhy-gold mb-2">0%</div>
                <div className="text-white/70 text-sm">State Income Tax</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 mb-2">$1B+</div>
                <div className="text-white/70 text-sm">Data Center Investment</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-400 mb-2">2.8%</div>
                <div className="text-white/70 text-sm">Job Growth Rate</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-400 mb-2">45M</div>
                <div className="text-white/70 text-sm">Annual Visitors</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-lmhy-charcoal">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="prose prose-lg max-w-none text-lmhy-charcoal/80">
                ...
                <h3 className="text-xl font-bold text-lmhy-charcoal mt-6 mb-3">Data Center Corridor</h3>
                <p>
              ...
              <div className="bg-lmhy-sand/20 rounded-xl p-6">
                <h3 className="font-bold text-lmhy-charcoal mb-4">Tech Impact on Real Estate</h3>
          ...
          <section className="mb-16 bg-gradient-to-br from-lmhy-coral to-lmhy-coral-dark text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    ...
                    <div className="text-white/70 text-sm">of all Las Vegas buyers from CA</div>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="text-2xl font-bold">$250K+</div>
                    <div className="text-white/70 text-sm">Avg. equity CA buyers bring</div>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="text-2xl font-bold">Bay Area & LA</div>
                    <div className="text-white/70 text-sm">Primary source markets</div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div className="mt-6">
                  <Link
                    ...
                    className="inline-flex items-center bg-white text-lmhy-coral px-4 py-2 rounded-md font-semibold hover:bg-lmhy-cream transition-colors"
                  >
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                <h3 className="font-bold text-lmhy-charcoal mb-3">Raiders & Sports</h3>
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                <h3 className="font-bold text-lmhy-charcoal mb-3">Healthcare Growth</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-3">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-xl p-6">
                <h3 className="font-bold text-lmhy-charcoal mb-3">Film & Production</h3>
                <p className="text-lmhy-charcoal/70 text-sm mb-3">
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center mb-6">
              <BarChart3 className="h-8 w-8 text-lmhy-coral mr-3" />
              <h2 className="text-3xl font-bold text-lmhy-charcoal">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lmhy-charcoal">Henderson</h3>
                ...
                <div className="text-sm text-lmhy-charcoal/60">
                  Hot areas: Inspirada, MacDonald Highlands, Green Valley Ranch
                </div>
              </div>
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lmhy-charcoal">Summerlin</h3>
                  <span className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-semibold">
                    Strong Buy
                  </span>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lmhy-charcoal">North Las Vegas</h3>
                  <span className="bg-lmhy-coral/10 text-lmhy-coral-dark px-2 py-1 rounded text-xs font-semibold">
                    Value Play
                  </span>
                </div>
                <p className="text-lmhy-charcoal/70 text-sm mb-3">
              ...
              <div className="bg-white rounded-xl p-6 border border-lmhy-sand/60">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-bold text-lmhy-charcoal">Southwest (Mountains Edge)</h3>
                  <span className="bg-lmhy-coral/10 text-lmhy-coral-dark px-2 py-1 rounded text-xs font-semibold">
                    Steady Growth
                  </span>
                </div>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-lmhy-coral/5 border border-blue-200 rounded-xl p-6">
                ...
                <ul className="space-y-3 text-lmhy-coral-dark">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 mr-2 mt-0.5 flex-shrink-0" />
                    <span>
