...
export const metadata = withPageCanonical(pageMetadata, "/about");
...
const personSchema = {
  ...
  url: "https://www.letmehelpyourealtor.com/about",
  worksFor: {
    "@type": "RealEstateAgent",
        ...
        <div className="lmhy-container">
          ...
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-lmhy-charcoal mb-4">Dr. Jan Duffy</h2>
                <p className="text-lg text-lmhy-coral mb-6">
                  REALTOR® | License S.0197614.LLC
                </p>

                <div className="prose prose-lg text-lmhy-charcoal/80 mb-8 space-y-4">
                  <p>
                ...
                {/* Contact Info */}
                <div className="bg-lmhy-sand/20 rounded-lg p-6 mb-8">
                  <h3 className="font-bold text-lmhy-charcoal mb-4">Contact Dr. Jan Duffy</h3>
                  <div className="space-y-3">
                    <a
                      href="tel:+17025001942"
                      className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral"
                    >
                      <Phone className="h-5 w-5 mr-3 text-lmhy-coral" />
                    ...
                    <a
                      ...
                      className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral"
                    >
                      <Mail className="h-5 w-5 mr-3 text-lmhy-coral" />
                      Homes@HeyBerkshire.com
                    </a>
                    <div className="flex items-start text-lmhy-charcoal/80">
                      <MapPin className="h-5 w-5 mr-3 text-lmhy-coral mt-0.5" />
                      <address className="not-italic">
                        9406 W Lake Mead Blvd, Suite 100<br />
                        Las Vegas, NV 89134
                      </address>
                    </div>
                    <div className="flex items-center text-lmhy-charcoal/80">
                      <Clock className="h-5 w-5 mr-3 text-lmhy-coral" />
                ...
                {/* Quote */}
                <blockquote className="border-l-4 border-lmhy-coral pl-6 italic text-lmhy-charcoal/80">
                  ...
                  <cite className="block mt-2 text-lmhy-charcoal font-semibold not-italic">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-blue-100 to-slate-100 rounded-lg p-8 aspect-square flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-lmhy-charcoal/70 font-semibold">Dr. Jan Duffy</p>
                    <p className="text-sm text-lmhy-charcoal/60">BHHS Nevada Properties</p>
                  </div>
                </div>

                {/* Stats Grid */}
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                    <div className="text-3xl font-bold text-lmhy-coral mb-1">Since 2008</div>
                    <div className="text-sm text-lmhy-charcoal/70">Serving Las Vegas</div>
                  </div>
                  <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                    <div className="text-3xl font-bold text-lmhy-coral mb-1">$127M+</div>
                    <div className="text-sm text-lmhy-charcoal/70">Volume Closed</div>
                  </div>
                  <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                    <div className="text-3xl font-bold text-lmhy-coral mb-1">500+</div>
                    <div className="text-sm text-lmhy-charcoal/70">Transactions</div>
                  </div>
                  <div className="bg-lmhy-coral/5 rounded-lg p-6 text-center">
                    <div className="text-3xl font-bold text-lmhy-coral mb-1">4.9★</div>
                    <div className="text-sm text-lmhy-charcoal/70">Client Rating</div>
                  </div>
                </div>

                {/* Quick Services */}
                <div className="bg-white border border-lmhy-sand/60 rounded-lg p-6">
                  <h3 className="font-bold text-lmhy-charcoal mb-4">Quick Links</h3>
                  <div className="space-y-2">
                    <Link href="/buyers" className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral">
                      <ArrowRight className="h-4 w-4 mr-2 text-lmhy-coral" />
                      Home Buying Guide
                    </Link>
                    <Link href="/sellers" className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral">
                      <ArrowRight className="h-4 w-4 mr-2 text-lmhy-coral" />
                      Selling Your Home
                    </Link>
                    <Link href="/home-valuation" className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral">
                      <ArrowRight className="h-4 w-4 mr-2 text-lmhy-coral" />
                      Free Home Valuation
                    </Link>
                    <a href="http://drjanduffy.realscout.com/" target="_blank" rel="noopener noreferrer" className="flex items-center text-lmhy-charcoal/80 hover:text-lmhy-coral">
                      <ArrowRight className="h-4 w-4 mr-2 text-lmhy-coral" />
                      Browse Listings
                    </a>
                  </div>
          ...
          <section className="mb-16 bg-lmhy-sand/20 rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-lmhy-charcoal mb-4 text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {specializations.map((spec) => (
                <div key={spec.title} className="bg-white rounded-lg p-6 border border-lmhy-sand/60">
                  <h3 className="font-bold text-lmhy-charcoal mb-2 flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    {spec.title}
                  </h3>
                  <p className="text-lmhy-charcoal/70 text-sm">{spec.description}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Why BHHS Section */}
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="text-center">
                <div className="bg-lmhy-coral rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="text-center">
              <Link
                ...
                className="inline-block bg-white text-lmhy-charcoal px-8 py-3 rounded-md font-semibold hover:bg-slate-100 transition-colors"
              >
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {areasServed.map((area) => (
                <div key={area} className="bg-lmhy-sand/20 rounded-lg p-4 text-center hover:bg-lmhy-cream transition-colors">
                  <Home className="h-5 w-5 mx-auto mb-2 text-lmhy-coral" />
                  <span className="text-lmhy-charcoal/80 font-medium">{area}</span>
                </div>
              ))}
            </div>
            <div className="text-center mt-6">
              <Link
                href="/neighborhoods"
                className="text-lmhy-coral font-semibold hover:text-lmhy-coral-dark inline-flex items-center"
              >
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-6">
                ...
                <p className="text-lmhy-charcoal/70 italic mb-3">
                ...
                <p className="text-lmhy-charcoal font-semibold">— Michael & Sarah T., Summerlin</p>
              </div>
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-6">
                <div className="flex items-center mb-3">
                  <Star className="h-5 w-5 text-yellow-400" />
                ...
                <p className="text-lmhy-charcoal font-semibold">— Jennifer & David K., Henderson</p>
              </div>
            </div>
          </section>
