...
export const metadata = withPageCanonical(pageMetadata, "/why-berkshire-hathaway");
...
const organizationSchema = {
  ...
  logo: "https://www.letmehelpyourealtor.com/favicon-32x32.png",
  description:
      ...
      <main className="pt-24 pb-16">
        <div className="lmhy-container">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-lmhy-charcoal/70 leading-relaxed">
          ...
          <section className="mb-16 bg-lmhy-charcoal text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-lmhy-charcoal-light rounded-lg p-8 text-center">
                <div className="text-6xl mb-4">🏛️</div>
                <p className="text-2xl font-bold mb-2">Fortune #1</p>
                <p className="text-lmhy-charcoal/50">
          ...
          <section className="mb-16 max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-lmhy-charcoal mb-12 text-center">
              The BHHS Advantage
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <Shield className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">Unmatched Trust</h3>
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <Users className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">Global Network</h3>
                <p className="text-lmhy-charcoal/70">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <Globe className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">World-Class Marketing</h3>
                <p className="text-lmhy-charcoal/70">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <Award className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">Ethical Standards</h3>
                <p className="text-lmhy-charcoal/70">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <TrendingUp className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">Financial Strength</h3>
                <p className="text-lmhy-charcoal/70">
              ...
              <div className="bg-white border border-lmhy-sand/60 rounded-lg p-8 hover:shadow-lg transition-shadow">
                <div className="bg-lmhy-coral/10 rounded-full p-4 w-16 h-16 flex items-center justify-center mb-6">
                  <CheckCircle className="h-8 w-8 text-lmhy-coral" />
                </div>
                <h3 className="text-xl font-bold text-lmhy-charcoal mb-3">Proven Results</h3>
                <p className="text-lmhy-charcoal/70">
          ...
          <section className="mb-16 bg-lmhy-coral text-white rounded-2xl p-8 md:p-12 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="text-white/70">Agents Worldwide</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">1,500+</div>
                <div className="text-white/70">Offices Globally</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">$138B+</div>
                <div className="text-white/70">Sales Volume (2024)</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold mb-2">#1</div>
                <div className="text-white/70">Most Trusted Brand</div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-lmhy-charcoal mb-6">
                  Your Local BHHS Expert in Las Vegas
                </h2>
                <p className="text-lg text-lmhy-charcoal/80 mb-6">
                ...
                <Link
                  href="/about"
                  className="text-lmhy-coral hover:text-lmhy-coral-dark font-semibold inline-flex items-center"
                >
                  Meet Dr. Jan Duffy →
                </Link>
              </div>
